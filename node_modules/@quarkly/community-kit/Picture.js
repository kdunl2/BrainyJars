...
var Picture = _atomize["default"].picture();
...
var PictureComponent = function PictureComponent(_ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement(Wrapper, rest, /*#__PURE__*/_react["default"].createElement(Picture, _extends({}, override('Picture Tag'), {
  ...
  }))), isEmpty && /*#__PURE__*/_react["default"].createElement(_ComponentNotice["default"], {
    message: 'Drag the Image and Source components here (optional)'
  }));
};

var _default = (0, _atomize["default"])(PictureComponent)({
  name: 'Picture',
  description: {
