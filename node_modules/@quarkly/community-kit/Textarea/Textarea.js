...
var Textarea = _atomize["default"].textarea();
...
var TextareaComponent = function TextareaComponent(_ref) {
  var name = _ref.name,
      ...
      props = _objectWithoutProperties(_ref, ["name", "placeholder", "value", "onChange", "defaultValue", "resize", "autoFocus", "required", "disabled", "children", "maxlength"]);

  var maxlength = parseInt(maxlengthFromProps, 10);
