...
var LightboxVideo = function LightboxVideo(_ref) {
  ...
  var getChildRef = function getChildRef(ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_widgets.Box, rest, /*#__PURE__*/_react["default"].createElement(_widgets.Box, _extends({}, override('Wrapper user element', "Wrapper user element".concat(offLightboxProp ? ':disabled' : ':active')), {
    ...
    onClick: closeLightbox
  }, override('Icon close'))), /*#__PURE__*/_react["default"].createElement(_Video["default"], _extends({
    onClick: function onClick(e) {
      return stopEventClick(e);
    },
    getChildRef: getChildRef
  }, override('Lightbox video', "Lightbox video".concat(isOpen ? ':open' : ':close'))))));
};
