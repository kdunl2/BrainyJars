...
var Video = _atomize["default"].video();
...
var VideoComponent = function VideoComponent(_ref) {
  var src = _ref.src,
      ...
      props = _objectWithoutProperties(_ref, ["src", "poster", "autoPlay", "controls", "muted", "loop", "playOnHover", "children"]);
  ...
  var srcVal = (0, _react.useMemo)(function () {
    return (src === null || src === void 0 ? void 0 : src.trim()) || undefined;
  }, [src]);
  ...
  (0, _react.useEffect)(function () {
    ...
    setEmpty(((_videoRef$current = videoRef.current) === null || _videoRef$current === void 0 ? void 0 : _videoRef$current.innerHTML) === '<!--child placeholder-->');
  }, [children]);
  return /*#__PURE__*/_react["default"].createElement(Wrapper, rest, /*#__PURE__*/_react["default"].createElement(Video, _extends({
    src: srcVal,
    poster: poster,
    autoPlay: autoPlay,
    controls: controls,
    muted: muted,
    loop: loop,
    onMouseEnter: playOnHover ? function (e) {
      return e.target.play();
    } : undefined,
    onMouseLeave: playOnHover ? function (e) {
...
var _default = (0, _atomize["default"])(VideoComponent)({
  name: 'Video',
  description: {
